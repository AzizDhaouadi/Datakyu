let dataLayerViewItemEvent = `
    window.dataLayer = window.dataLayer || [];
    window.dataLayer.push({
        <br>
        <span class="indent">'event': 'view_item'</span>,
        <br>
...
fetch(\`https://www.google-analytics.com/mp/collect?measurement_id=\${measurement_id}&api_secret=\${api_secret}\`, {
  ...
  body: JSON.stringify({
    ...
    events: [{
      <br>
      <span class="indent">name: 'view_item'</span>,
      <br>
...
export {dataLayerViewItemEvent, gtagViewItemEvent, apiViewItemEvent};