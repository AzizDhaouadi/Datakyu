let dataLayerAddToCartEvent = `
    window.dataLayer = window.dataLayer || [];
    window.dataLayer.push({
        <br>
        <span class="indent">'event': 'add_to_cart'</span>,
        <br>
...
fetch(\`https://www.google-analytics.com/mp/collect?measurement_id=\${measurement_id}&api_secret=\${api_secret}\`, {
  ...
  body: JSON.stringify({
    ...
    events: [{
      <br>
      <span class="indent">name: 'add_to_cart'</span>,
      <br>
...
export {dataLayerAddToCartEvent, gtagAddToCartEvent, apiAddToCartEvent};