let dataLayerAddShippingInfoEvent = `
    ...
    window.dataLayer.push({
        <br>
        <span class="indent">'event': 'add_shipping_info'</span>,
        <br>
        <span class="indent">'currency': 'USD'</span>,
        <br>
        <span class="indent">'value': 9.99</span>,
        <br>
        <span class="indent">'shipping_tier': 'Ground'</span>,
        <br>
...
fetch(\`https://www.google-analytics.com/mp/collect?measurement_id=\${measurement_id}&api_secret=\${api_secret}\`, {
  ...
  body: JSON.stringify({
    ...
    events: [{
      <br>
      <span class="indent">name: 'add_shipping_info'</span>,
      <br>
      <span class="indent">params: {
        ...
        <span class="indent">'value': 22.3</span>,
        <br>
        <span class="indent">'payment_type': 'Ground'</span>,
        <br>
        <span class="indent">'coupon': 'Summer_Fun'</span>,
        <br>
        <span class="indent">items: [</span>
